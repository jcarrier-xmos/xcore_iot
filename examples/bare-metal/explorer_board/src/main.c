...
void main_tile0(chanend_t c0, chanend_t c1, chanend_t c2, chanend_t c3)
{
    ...
    PAR_JOBS (
        ...
        PJOB(ap_stage_b, (s_chan_ab.end_b, s_chan_bc.end_a, tile0_ctx->c_from_gpio)),
        PJOB(ap_stage_c, (s_chan_bc.end_b, s_chan_output.end_a, tile0_ctx->c_to_gpio)),
