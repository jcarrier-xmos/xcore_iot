...
#**********************
set(FATFS_CONTENTS_DIR ${CMAKE_BINARY_DIR}/example_freertos_explorer_board/fatmktmp)
set(FATFS_FILE ${CMAKE_BINARY_DIR}/example_freertos_explorer_board/example_freertos_explorer_board_fat.fs)
add_custom_target(
...
set_target_properties(example_freertos_explorer_board_fat.fs PROPERTIES
    ADDITIONAL_CLEAN_FILES ${CMAKE_BINARY_DIR}/example_freertos_explorer_board
)
